...
namespace Practico3AJAX.Controllers
{
    public class HerramientasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,IdMarca,CantidadTotal,Disponibles,Estado")] Herramienta herramienta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,IdMarca,CantidadTotal,Disponibles,Estado")] Herramienta herramienta)
        {
