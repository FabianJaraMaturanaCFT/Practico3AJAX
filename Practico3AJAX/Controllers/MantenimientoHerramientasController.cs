...
namespace Practico3AJAX.Controllers
{
    public class MantenimientoHerramientasController : Controller
    {
        ...
        {
              return _context.MantenimientoHerramientas != null ? 
                          View(await _context.MantenimientoHerramientas.ToListAsync()) :
                          Problem("Entity set 'ProyectoDBContext.MantenimientoHerramientas'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,IdUnidadHerramienta,FechaInicio,FechaFin")] MantenimientoHerramienta mantenimientoHerramienta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdUnidadHerramienta,FechaInicio,FechaFin")] MantenimientoHerramienta mantenimientoHerramienta)
        {
